...
# Birger Moëll
<img width="650px" src="./assets/abstract.png" alt="Abstract geometric artwork" width="100%" />
...
| Role | Focus |
| --- | --- |
| [AI Sweden](https://www.ai.se/sv/ai-labs/sprakteknologier-nlu) | Senior Research Scientist in the NLU team, working on language models and applied language technology for Swedish and European needs |
| [Uppsala University](https://www.uu.se/en/contact-and-organisation/staff?query=N26-41) | Senior Lecturer in Computational Linguistics, teaching and researching NLP, speech technology, and AI in healthcare |
| [Eir Space](https://eir.space/) | Co-founder, building privacy-first health tools that help people understand and use their own health data |
| [Open Source](https://github.com/BirgerMoell) | Medical AI benchmarks, health data tools, Swedish NLP resources, local-first apps, datasets, and models |
...
### [Eir Open](https://github.com/Eir-Space/eir-open)
...
- [Health.md](https://github.com/Eir-Space/eir-open/tree/main/open-health-standard/health-md-standard), a lightweight standard for LLM-readable health records.
...
> Moëll, B., Farestam, F., & Beskow, J. (2025). [Swedish Medical LLM Benchmark: development and evaluation of a framework for assessing large language models in the Swedish medical domain](https://doi.org/10.3389/frai.2025.1557920). *Frontiers in Artificial Intelligence*, 8, 1557920.

### [Health Journal](https://github.com/BirgerMoell/health-journal)
...
### [Pataka Test](https://github.com/BirgerMoell/pataka-test)
...
More: [Google Scholar](https://scholar.google.com/citations?user=4lPZnEAAAAAJ&hl=en)

## Models, Datasets, and Tools

I publish experimental models, datasets, and demos on [Hugging Face](https://huggingface.co/birgermoell), including:
...
- Website: [birgermoell.com](https://birgermoell.com/)
- GitHub: [github.com/BirgerMoell](https://github.com/BirgerMoell)
- Google Scholar: [Birger Moëll](https://scholar.google.com/citations?user=4lPZnEAAAAAJ&hl=en)
- Hugging Face: [huggingface.co/birgermoell](https://huggingface.co/birgermoell)
